...
$group_fields = get_field_value($global_options, 'conacts_us');

$title = get_field_value($group_fields, 'title');
$description = get_field_value($group_fields, 'description');

$socials = get_field_value($group_fields, 'socials');
